...
function Projects() {
    return ( 
        <div className="flex justify-center items-center w-full">
            <div id="Projects" className="flex flex-row flex-wrap lg:w-10/12 items-center justify-evenly space-y-2 p-1 my-20 mx-10 sm:mx-10 rounded-2xl bg-black shadow-2xl shadow-violet-500 w-auto h-screen sm:h-fit overflow-y-scroll overflow-x-hidden sm:overflow-x-auto border-2 border-violet-700">
                <Pcard
