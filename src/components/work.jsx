function Work() {
    return (
        <div id="Experiance" className="w-fit max-w-xl mx-auto mt-8 px-4 py-6 rounded-2xl shadow-md bg-black shadow-violet-500 font-sans transition-colors border-violet-700 border-2 duration-300 ">
